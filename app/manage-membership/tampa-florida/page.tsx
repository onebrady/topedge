...
export const metadata: Metadata = {
  title: "Manage Your Membership - Tampa, FL - Top Edge Car Wash",
  description: "Manage your Top Edge Car Wash unlimited membership at our Tampa, Florida location. Update payment methods, pause or cancel your membership, and modify vehicle information.",
};

export default function ManageMembershipTampa() {
  const breadcrumbs = generateBreadcrumbSchema([
    { name: 'Home', url: 'https://topedgecarwashes.com' },
    { name: 'Manage Membership', url: 'https://topedgecarwashes.com/manage-membership' },
    { name: 'Tampa', url: 'https://topedgecarwashes.com/manage-membership/tampa-florida' },
  ]);
        ...
        <section className="pt-32 pb-12 bg-gradient-to-b from-primary/5 to-background">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center">
              <p className="text-lg text-primary font-semibold mb-4">Tampa, Florida</p>
                  ...
                  <div className="bg-card rounded-lg shadow-elegant overflow-hidden border border-border">
                    <div className="p-6">
                      <div className="w-full">
                        <iframe
                          src="https://riptidetopedge.app.rinsed.co/ticket_forms/67"
                          className="rinsed-frame"
                          style={{ border: 'none', display: 'block', width: '100%', height: '1075px' }}
                          title="Manage Membership - Tampa"
                          scrolling="no"
                        />
                      </div>
